...
<body>
    ...
    <div class="d-flex flex-row text-white">
      ...
      <div class="p-2"><i class="fas fa-mobile fa-2x text-dark"> 999-555-2224</i></div>
    </div>
    <div class="d-flex flex-row-reverse text-white">
      <div class="p-1"><a class="btn btn-sm  btn-success waves-effect" href="">Admin Login</a></div>
      <div class="p-1"><a class="btn btn-sm  btn-success waves-effect" href="">Staff Login</a></div>
    </div>
  </nav>
...
<nav class="navbar navbar-expand-lg navbar-dark elegant-color-dark">
  <div class="container">
      <!-- Navbar brand -->
      <a class="navbar-brand" href="#">Erum</a>
      ...
      <div class="carousel-item active">
        <div class="view" style="background-image: url('https://images.pexels.com/photos/1170412/pexels-photo-1170412.jpeg?cs=srgb&dl=people-sitting-on-chairs-beside-their-desks-in-an-office-1170412.jpg&fm=jpg'); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="mask rgba-black-light d-flex justify-content-center align-items-center">
            ...
            <!-- Content -->
            <div class="animated fadeInLeft text-center white-text mx-5">
              <h1 class="mb-4" style="font-size: 5em;">
                <strong>Erum Professionals</strong>
              </h1>

              <p style="font-size: 2em;">
                <strong>All Solutions Under One Roof</strong>
              </p>

              <p class="mb-4 d-none d-md-block">
                <strong>Optimize tax costs using our years experience</strong>
              </p>
        ...
        <div class="row features-small mb-5 mt-3 wow fadeIn">
          ...
          <div class="col-md-4">
            ...
            <div class="row">
              ...
              <div class="col-10">
                <h6 class="feature-title">Account Outscoring</h6>
                <p class="grey-text">Our experts are ready to manimize the costs associated with the payment of the taxes by using absolutely legal,legitimate and effective method. <a class="text-warning" href=""><i class="fas fa-arrow-right"> Explore More</i></a>
                </p>
                <div style="height:5px;"></div>
              </div>
          ...
          <div class="col-md-4 mt-2">
            ...
            <div class="row">
              ...
              <div class="col-10">
                <h6 class="feature-title">All types of other Government Works</h6>
                <p class="grey-text">Our experts are ready to manimize the costs associated with the payment of the taxes by using absolutely legal,legitimate and effective method. <a class="text-warning" href=""><i class="fas fa-arrow-right"> Explore More</i></a>
                </p>
                <div style="height:5px;"></div>
              </div>
          ...
          <div class="row">
            ...
            <div class="col-md-7 d-flex align-items-center">
              <div>
                ...
                <h3 class="font-weight-bold mb-4">Ahmed ALi</h3>
        ...
        <div class="jumbotron card card-image" style="background-image: url('https://mdbootstrap.com/img/Photos/Slides/img%20(70).jpg');">
          <div class="mask rgba-black-strong text-white text-center py-5 px-4">
            <div>
              ...
              <a class="btn btn-warning btn-lg text-dark">Contact Us <i class="fas fa-angle-right"></i> </a>
            </div>
          </div>
        </div>
      </section>
